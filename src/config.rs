...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("KimFu".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["14.103.157.244"];
pub const RS_PUB_KEY: &str = "lrnTFQ2XT6IJ8NOsAQJtYdzLT5ErgG7xX4ELyRpHaRw=";
